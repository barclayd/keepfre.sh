export const Navbar = () => (
  <nav className="fixed flex top-0 z-1 py-4 w-full backdrop-blur-[20px] border-b-[3px] border-[rgba(221,226,227,0.5)] bg-gradient-to-b">
    <div className="mx-auto flex w-6/10 max-w-7xl items-center justify-between">
      ...
      <button
        type="button"
        className="cursor-pointer border-[3px] border-[rgba(221,226,227,0.5)] py-2.5 px-2 rounded-2xl"
      >
        Download
      </button>
    </div>
